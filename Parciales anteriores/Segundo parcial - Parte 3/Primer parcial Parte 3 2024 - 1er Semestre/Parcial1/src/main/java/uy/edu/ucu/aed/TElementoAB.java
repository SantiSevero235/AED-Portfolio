...
public class TElementoAB<T> implements IElementoAB<T> {
    ...
    public int longitudTrayectoriaInterna(int nivelActual) {
        int suma = nivelActual;

        if (hijoIzq != null) {
            suma += hijoIzq.longitudTrayectoriaInterna(nivelActual + 1);
        }
        if (hijoDer != null) {
            suma += hijoDer.longitudTrayectoriaInterna(nivelActual + 1);
        }
        return suma;
    }

    public int obtenerAltura() {
        int alturaIzq = (hijoIzq != null) ? hijoIzq.obtenerAltura() : 0;
        int alturaDer = (hijoDer != null) ? hijoDer.obtenerAltura() : 0;
